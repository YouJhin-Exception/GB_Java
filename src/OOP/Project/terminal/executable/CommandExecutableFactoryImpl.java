...
public class CommandExecutableFactoryImpl implements CommandExecutableFactory {
    ...
    public CommandExecutableFactoryImpl(UserService<Student, Integer> studentService) {
    ...
    public CommandExecutable create(Command input) {
        ...
        if (input.isCreateCommand()) {
            ...
            return null; //CreateStudentExecutable(studentService,new Student(input)); // подумать над фабрикой которая будет собирать студента из 7 инпутов
        }
